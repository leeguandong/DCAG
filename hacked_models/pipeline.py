    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # Compute grag_scale for this step
                current_grag_scale = grag_scale.copy()
                ...
                with self.transformer.cache_context("cond"):
                    noise_pred = self.transformer(
                        ...
                        return_dict=False,
                        grag_scale=current_grag_scale,
                    )[0]
                    noise_pred = noise_pred[:, : latents.size(1)]

                if do_true_cfg:
                    # Get a fresh scale list (the previous one was consumed by .pop())
                    neg_grag_scale = grag_scale.copy()
